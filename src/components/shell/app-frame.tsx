    ...
    <>
      <header className="fixed inset-x-0 top-0 z-50 mx-auto flex h-[calc(var(--header-height)+env(safe-area-inset-top))] max-w-3xl items-end bg-morocco px-4 pb-2 pt-[env(safe-area-inset-top)] text-ivory shadow-lg">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <div className="min-w-0"><p className="truncate font-display text-lg font-bold leading-tight">{trip.name}</p><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-sand">Marrakech Crew</p></div>
        </div>
        <SyncIndicator />
